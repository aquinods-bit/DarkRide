...
// Copyright (c) 2025 Ethereal Grace. All rights reserved.
...
namespace EtherealGrace.MaterialTools
{
    [InitializeOnLoad]
    public static class AutoSwitchMaterialShader
    {
        private static readonly string targetFolder = "Assets/ModernTableChairSet/Models_Materials/Materials"; // <-- CHANGE THIS
